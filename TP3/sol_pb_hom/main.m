...
% change directory
cd('/home/philippe/Documents/MATLAB/X01/TP3/sol_pb_hom');

% load the mesh
addpath('/home/philippe/Documents/MATLAB/X01/TP3/sol_pb_hom/Mesh')
...
Anum = 1; % choisir Anum et changer f.m pour typeA == 0
% -----------------------------------------------------------------------------------------------------------------------
